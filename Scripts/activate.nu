...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Desktop\_Python\ReconhecimentoFacialCatraca'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Desktop\_Python\ReconhecimentoFacialCatraca\Scripts\deactivate.nu'
